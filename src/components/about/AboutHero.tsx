...
const AboutHero = () => {
    ...
    return (
        <section className="min-h-screen w-full bg-[#E5E7EB] flex flex-col items-center justify-center p-4 md:p-6 lg:p-0">
            <motion.div variants={containerVariants} initial="hidden" animate="visible" className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 min-h-[600px]">
                {/* Left Card - Main Hero */}
                <div className="bg-white rounded-3xl p-8 md:p-12 flex flex-col justify-between h-full">
                    <div>
                        <span className="text-xl md:text-2xl font-medium text-black block mb-4">About me</span>
                        <div className="flex flex-col gap-1">
                            <TextAnimation
                                text="I'm versatile"
                                variant="wordUp"
                                delay={0.2}
                                className="text-5xl md:text-7xl lg:text-8xl font-medium text-black tracking-tighter leading-[0.9]"
                            />
                            <TextAnimation
                                text="designer"
                                variant="wordUp"
                ...
                <div className="flex flex-col gap-4 md:gap-6 h-full">
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-10 flex-1 flex items-center">
                        <p className="text-lg md:text-xl text-zinc-600 leading-relaxed font-light">
                            For each project, I strive to create elegant and meaningful solutions for the end user. I can work independently on projects as well as with a team if required. By the way, I regularly work with the amazing people at Zenite Lab, a digital design studio.
                        </p>
                    </div>
                </div>
            </motion.div>
