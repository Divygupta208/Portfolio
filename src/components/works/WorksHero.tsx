...
import { ArrowUpRight, X, Play, Eye } from "lucide-react";
...
const projects: Project[] = [
    {
        ...
        longDescription:
            "Zenith is a comprehensive digital publishing platform built to handle high-traffic editorial content. It features a custom CMS, real-time analytics, and a fully responsive design tailored for a premium reading experience.",
        image:
    ...
    },
    {
        ...
        longDescription:
            "Arunika focuses on minimalist aesthetics combined with powerful interactive elements. The landing page uses advanced WebGL transitions and a fluid layout system to engage users from the first second.",
        image:
...
export default function WorkHero() {
    ...
    return (
        <section className="min-h-screen w-full px-4 md:px-6 lg:p-0">
            {/* Header */}
            <div className="w-full max-w-6xl mx-auto bg-white py-20 rounded-4xl  mb-12 text-center flex flex-col justify-center items-center">
                <TextAnimation
                    text="The Work I Did"
                    variant="wordUp"
                    delay={0.5}
                    trigger={true}
                    className="mb-2 md:mb-4 text-4xl md:text-6xl lg:text-8xl text-black font-medium leading-tight"
                />
                <TextAnimation
            ...
            <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4">
                {projects.map((project) => (
                    <motion.div
                        ...
                        className="bg-black/80 rounded-2xl p-4 flex items-center gap-4 shadow-sm border border-white/5 cursor-pointer hover:bg-black transition-colors group"
                    >
                    ...
                    <>
                        ...
                        <div className="fixed inset-0 grid place-items-center z-[100] pointer-events-none p-4">
                            <motion.div
                                ...
                                className="w-full max-w-150 h-fit max-h-[80vh] md:max-h-[90vh] flex flex-col bg-white dark:bg-neutral-900 rounded-3xl overflow-hidden shadow-2xl pointer-events-auto"
                            >
                                <div className="relative">
                                    <motion.div
                                        layoutId={`image-${activeProject.id}-${id}`}
                                        className="w-full h-60 sm:h-72 aspect-video"
                                    >
                                        <img
                                        ...
                                        <div className="pt-6 border-t border-gray-100 dark:border-zinc-800">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {activeProject.techStack.map((tech) => (
                                                    <span
                                                        key={tech}
                                                        className="text-xs font-medium text-gray-600 dark:text-zinc-400 bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 px-3 py-1 rounded-full"
                                                    >
                                                        {tech}
                                                    </span>
                                                ))}
